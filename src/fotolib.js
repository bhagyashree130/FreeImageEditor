...
//         root.operationOrgCtx.clearRect(
//           0,
//           0,
//           root.operationOrgCanvas.width,
//           root.operationOrgCanvas.height
//         );
//         root.operationEditedCtx.clearRect(
//           0,
//           0,
...
//         root.imageData = root.operationOrgCtx.getImageData(
//           0,
//           0,
//           root.operationOrgCanvas.width,
//           root.operationOrgCanvas.height
...
//     for (var i = 0; i < modifiedImageData.data.length; i = i + 4) {
//       if (
//         Math.abs(modifiedImageData.data[i] - this.pickedR) < 20 &&
...
//     if (canvas == undefined) image.src = root.operationEditedCanvas.toDataURL();
//     else {
